...
import {
  ...
  Star, Bell, Calendar, CheckSquare, Map, LifeBuoy,
  Briefcase, Database, ChevronsLeft, ChevronsRight, X,
} from "lucide-react";
...
const navItems = [
  ...
  { to: "/dashboard/data-requests", label: "Data Requests", icon: Database },
